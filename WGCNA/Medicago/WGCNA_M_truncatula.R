#Script to perform Weighted Gene Coexpression Network Analysis on Medicago truncatula Genes
...
jpeg(
    "Figures/sampleClustering_Mtruncatula.jpeg",
    width = 20,
    height = 10,
    units = "in",
    res = 300,
...
# # # Plot the results
jpeg(
    "Figures/SoftPowerThreshold.jpeg",
    width = 10,
    height = 7,
    units = "in",
    res = 300,
...
jpeg(
    "Figures//GeneDendrogram_ModuleColors.jpeg",
    width = 20,
    height = 10,
    units = "in",
    res = 300,
...
png(
    "Figures//ModuleTraitRelationship_Mtruncatula.png",
    width = 8,
    height = 13,
    units = "in",
    res = 600
